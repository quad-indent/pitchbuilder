# Ripped and slightly modified from https://github.com/ZulfadhliM/python-mir
# BEST REPO EVER
# FIVE YEAR OLD CODE OUTPERFORMING FUCKING AI LETS FUCKING GO ZULFADHLI
...
class PitchEstimation(object):
    ...
    """
    def __init__(self, inputSignal, fs = 44100, windowSize = 0.08, hopTime = 0.01, minFreq = 35, threshold = 0.1):
        self.fs = fs
...
def pePitch(fs:np.ndarray, sampleRate):
    peCunt = PitchEstimation(fs, sampleRate)
    return peCunt.getPitches()